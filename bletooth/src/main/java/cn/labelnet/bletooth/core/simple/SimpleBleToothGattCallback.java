 ...
 * <p>
 * @Date Created in 1:32 PM 2/15/2017
 * @Desc Desc
 * 示例 ： BluetoothGatt Callback
 */

public class SimpleBleToothGattCallback extends BleGattCallback {
    ...
    /**
     * init context for sendBroadCast
     *
     * @param mContext application context
     */
    public SimpleBleToothGattCallback(Context mContext) {
